...
ListItem {
    ...
    property var quotedMessageData: typeof modelData.quote !== 'undefined' ? modelData.quote : null // required properties: message, source, outgoing, attachments, AND id, index
