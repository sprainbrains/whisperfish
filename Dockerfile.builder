...
RUN sdk-manage develpkg install SailfishOS-$SFOS_VERSION-aarch64 sqlcipher-devel
...
RUN sudo rm -rf /srv/mer/targets/SailfishOS-$SFOS_VERSION-aarch64/var/cache/zypp/*
